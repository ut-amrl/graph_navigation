...
class Navigation {
   public:
    ...
    void SetSafePose(const Eigen::Vector2f &loc, float angle);
    void Resume();
    bool PlanStillValid();
    ...
    bool ExtractSafePose(Eigen::Vector2f &loc, float &angle);
   ...
   private:
    ...
    float safe_local_target_angle_;
};

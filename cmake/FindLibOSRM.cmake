...
find_path(LibOSRM_INCLUDE_DIRS osrm.hpp
  # PATH_SUFFIXES osrm include/osrm include
  HINTS /usr/local/include/osrm 
  ${PC_LibOSRM_INCLUDEDIR} ${PC_LibOSRM_INCLUDE_DIRS}
  ~/Library/Frameworks
  /Library/Frameworks
  /usr/local
  /usr
...
# If `find_path` didn't set `LibOSRM_INCLUDE_DIRS`, set it explicitly
if(NOT LibOSRM_INCLUDE_DIRS)
  set(LibOSRM_INCLUDE_DIRS "/usr/local/include/osrm")
endif()

...
NavigationParameters = {
  ...
  image_topic = "/bev/stitched/compressed";
  ...
  carrot_dist = 20.5;  -- large carrot distance so the goal does not latch onto the map
  system_latency = 0.24;
...
TerrainEvaluator = {
  ...
  rollout_density = 20;
  model_path = "/home/eyang/tmp/fullcostnet_19.pt";
